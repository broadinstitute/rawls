...
object Dependencies {
  ...
  val workbenchGoogle2: ModuleID = "org.broadinstitute.dsde.workbench" %% "workbench-google2" % "0.5-ccb6a27-SNAP" excludeAll(excludeWorkbenchModel, excludeWorkbenchUtil)
