...
object Dependencies {
  ...
  // metrics-statsd-common provided locally in the /lib directory; exclude it here
  val metricsStatsd: ModuleID =      "com.readytalk"         %  "metrics3-statsd"  % "4.2.0" exclude("com.readytalk", "metrics-statsd-common")
