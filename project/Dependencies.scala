...
object Dependencies {
  ...
  val workbenchGoogle2: ModuleID = "org.broadinstitute.dsde.workbench" %% "workbench-google2" % "0.5-b759825-SNAP" excludeAll(excludeWorkbenchModel, excludeWorkbenchUtil)
