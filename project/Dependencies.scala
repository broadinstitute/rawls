...
object Dependencies {
  ...
  val googleGuava: ModuleID =             "com.google.guava"  % "guava" % "32.0.1-jre"
  ...
  val billingProfileManager = excludeJakarta("bio.terra" % "billing-profile-manager-client" % "0.1.161-SNAPSHOT")
