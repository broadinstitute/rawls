...
object Dependencies {
  ...
  val workbenchModelV  = "0.13-c363d83-SNAP"
  ...
  val workbenchGoogle2: ModuleID = "org.broadinstitute.dsde.workbench" %% "workbench-google2" % "0.5-b791bcf-SNAP" excludeAll(excludeWorkbenchModel, excludeWorkbenchUtil)
