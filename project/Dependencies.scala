...
object Dependencies {
  ...
  val workbenchGoogle2: ModuleID = "org.broadinstitute.dsde.workbench" %% "workbench-google2" % "0.6-4df42ca" % "provided" excludeAll(excludeWorkbenchModel, excludeWorkbenchUtil)
