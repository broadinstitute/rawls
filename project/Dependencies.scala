...
object Dependencies {
  ...
  val billingProfileManager = excludeJakarta("bio.terra" % "billing-profile-manager-client" % "0.1.140-SNAPSHOT")
  val terraCommonLib = tclExclusions(excludeJakarta("bio.terra" % "terra-common-lib" % "0.0.87-SNAPSHOT" classifier "plain"))
