...
object Dependencies {
  ...
  val billingProfileManager = excludeJakarta("bio.terra" % "billing-profile-manager-client" % "0.1.195-SNAPSHOT")
  ...
  val leonardo: ModuleID = "org.broadinstitute.dsde.workbench" % "leonardo-client_2.13" % "1.3.6-c331e18-SNAP"
