...
object Dependencies {
  ...
  val terraCommonLib = tclExclusions(clientLibExclusions("bio.terra" % "terra-common-lib" % "1.1.45-SNAPSHOT" classifier "plain"))
  ...
  val policyService = clientLibExclusions("bio.terra" % "terra-policy-client" % "1.0.36-SNAPSHOT")
