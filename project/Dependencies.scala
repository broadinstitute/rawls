...
object Dependencies {
  ...
  val workbenchGoogle2: ModuleID = "org.broadinstitute.dsde.workbench" %% "workbench-google2" % "0.6-8016a54-SNAP" excludeAll(excludeWorkbenchModel, excludeWorkbenchUtil)
