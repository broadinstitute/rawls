...
object Dependencies {
  ...
  val googleStorageLocal: ModuleID = "com.google.cloud" % "google-cloud-nio" % "0.126.11" % "test"
  ...
  val terraCommonLib = tclExclusions(excludeJakarta("bio.terra" % "terra-common-lib" % "0.0.83-SNAPSHOT" classifier "plain"))
