...
object Dependencies {
  ...
  val googleStorageLocal: ModuleID = "com.google.cloud" % "google-cloud-nio" % "0.124.8" % "test"
  ...
  val workspaceManager = excludeJakarta("bio.terra" % "workspace-manager-client" % "0.254.318-SNAPSHOT")
