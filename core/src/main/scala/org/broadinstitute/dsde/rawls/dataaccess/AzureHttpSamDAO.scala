...
class AzureHttpSamDAO(baseSamServiceURL: String, timeout: FiniteDuration)(implicit
  ...
  private class DisabledSamApiCallback[T](functionName: String) extends ApiCallback[T] {
  ...
  override def getPolicySyncStatus(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[sam.model.SyncStatus]("syncStatus")
  ...
  override def listUserRolesForResource(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[util.List[String]]("resourceRolesV2")
  ...
  override def listUserActionsForResource(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[util.List[String]]("resourceActionsV2")
  ...
  override def createResourceFull(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[Void]("createResourceV2")
  ...
  override def listPoliciesForResource(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[util.List[sam.model.AccessPolicyResponseEntryV2]]("listResourcePoliciesV2")
  ...
  override def registerUser(ctx: RawlsRequestContext): Future[Option[RawlsUser]] =
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[sam.model.UserStatus]("createUserV2")
  ...
  override def getUserStatus(ctx: RawlsRequestContext): Future[Option[SamUserStatusResponse]] =
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[sam.model.UserStatusInfo]("getUserStatusInfo")
  ...
  override def getUserIdInfo(userEmail: String, ctx: RawlsRequestContext): Future[SamDAO.GetUserIdInfoResult] =
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[sam.model.UserIdInfo]("getUserIds")
  ...
  override def createResource(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[Void]("createResourceWithDefaultsV2")
  ...
  override def deleteResource(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[Void]("deleteResourceV2")
  ...
  override def userHasAction(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[java.lang.Boolean]("resourcePermissionV2")
  ...
  override def getPolicy(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[sam.model.AccessPolicyMembershipV2]("getPolicyV2")
  ...
  override def listResourceChildren(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[util.List[sam.model.FullyQualifiedResourceId]]("listResourceChildren")
  ...
  override def overwritePolicy(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[Void]("overwritePolicyV2")
  ...
  override def addUserToPolicy(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[Void]("addUserToPolicyV2")
  ...
  override def removeUserFromPolicy(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[Void]("removeUserFromPolicyV2")
  ...
  override def inviteUser(userEmail: String, ctx: RawlsRequestContext): Future[Unit] =
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[sam.model.UserStatusDetails]("inviteUser")
  ...
  override def getUserIdInfoForEmail(userEmail: WorkbenchEmail): Future[UserIdInfo] =
    throw new NotImplementedError("getUserIdInfoForEmail is not implemented for Azure.")

  override def syncPolicyToGoogle(resourceTypeName: SamResourceTypeName,
                                  resourceId: String,
                                  policyName: SamResourcePolicyName
                                 ): Future[Map[WorkbenchEmail, Seq[SyncReportItem]]] =
    throw new NotImplementedError("syncPolicyToGoogle is not implemented for Azure.")
  ...
  override def listUserResources(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[util.List[sam.model.UserResourcesResponse]]("listResourcesAndPoliciesV2")
  ...
  override def getPetServiceAccountKeyForUser(googleProject: GoogleProjectId,
    ...
    throw new NotImplementedError("getPetServiceAccountKeyForUser is not implemented for Azure.")

  override def deleteUserPetServiceAccount(googleProject: GoogleProjectId, ctx: RawlsRequestContext): Future[Unit] =
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[Void]("deletePetServiceAccount")
  ...
  override def getDefaultPetServiceAccountKeyForUser(ctx: RawlsRequestContext): Future[String] =
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[String]("getArbitraryPetServiceAccountKey")
  ...
  override def getUserArbitraryPetServiceAccountKey(userEmail: String): Future[String] =
    throw new NotImplementedError("getUserArbitraryPetServiceAccountKey is not implemented for Azure.")

  override def getUserPetServiceAccount(ctx: RawlsRequestContext,
                                        googleProjectId: GoogleProjectId
                                       ): Future[WorkbenchEmail] =
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[String]("getPetServiceAccount")
  ...
  override def getResourceAuthDomain(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[util.List[String]]("getAuthDomainV2")
  ...
  override def listAllResourceMemberIds(resourceTypeName: SamResourceTypeName,
    ...
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[util.List[sam.model.UserIdInfo]]("getAllResourceUsersV2")
  ...
  override def getAccessInstructions(groupName: WorkbenchGroupName, ctx: RawlsRequestContext): Future[Option[String]] =
    retry(when401or5xx) { () =>
      val callback = new DisabledSamApiCallback[String]("getAccessInstructions")
  ...
  override def admin: SamAdminDAO = new SamAdminDAO {
    override def listPolicies(resourceType: SamResourceTypeName,
      ...
      retry(when401or5xx) { () =>
        val callback = new DisabledSamApiCallback[util.List[sam.model.AccessPolicyResponseEntryV2]]("adminListResourcePolicies")
    ...
    override def addUserToPolicy(resourceTypeName: SamResourceTypeName,
      ...
      retry(when401or5xx) { () =>
        val callback = new DisabledSamApiCallback[Void]("adminAddUserToPolicy")
    ...
    override def removeUserFromPolicy(resourceTypeName: SamResourceTypeName,
      ...
      retry(when401or5xx) { () =>
        val callback = new DisabledSamApiCallback[Void]("adminRemoveUserFromPolicy")
  ...
  override def getStatus(): Future[SubsystemStatus] = {
    val callback = new DisabledSamApiCallback[sam.model.SystemStatus]("getSystemStatus")
...
class DisabledSpanSettingInterceptor(span: Span) extends Interceptor {
