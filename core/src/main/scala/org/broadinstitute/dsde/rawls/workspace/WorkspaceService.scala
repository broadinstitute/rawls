...
object WorkspaceService {
  def constructor(dataSource: SlickDataSource, cromiamDAO: ExecutionServiceDAO,
    ...
    new WorkspaceService(userInfo, dataSource, cromiamDAO,
