...
/**
 * Deferred execution in Scala (Futures, IOs, DBIOs, etc) result in a thread switchery. OpenTelemetry tracing
 ...
 */
@Provider
class WithOtelContextFilter(otelContext: Context) extends ClientRequestFilter with ClientResponseFilter {
