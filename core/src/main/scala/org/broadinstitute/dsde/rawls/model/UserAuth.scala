...
case class RawlsBillingProject(projectName: RawlsBillingProjectName, ownerPolicyEmail: RawlsGroupEmail, cromwellAuthBucketUrl: String, status: CreationStatuses.CreationStatus, billingAccount: Option[RawlsBillingAccountName], message: Option[String])
