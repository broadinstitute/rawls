...
import org.broadinstitute.dsde.rawls.model.{Agora, AgoraEntity, AgoraMethodConfiguration, AttributeString, MethodConfigurationNamePair,ErrorReport, ErrorReportSource, MethodConfiguration, MethodConfigurationName, MethodConfigurationShort, MethodInputsOutputs, MethodRepoConfigurationExport, MethodRepoConfigurationImport, MethodRepoMethod, RawlsRequestContext, SamWorkspaceActions, UserInfo, ValidatedMethodConfiguration, WDL, Workspace, WorkspaceName}
...
object MethodConfigurationService {
  ...
  workbenchMetricBaseName: String,
    ...
    new MethodConfigurationService(ctx, dataSource, samDAO, methodRepoDAO, methodConfigResolver, entityManager, workspaceRepository, workbenchMetricBaseName)
}
...
class MethodConfigurationService(
    ...
    with MethodWiths
  {
    ...
    private def gatherMethodConfigInputs(
      ...
      methodRepoDAO.getMethod(methodConfig.methodRepoMethod, ctx.userInfo).map {
        case None =>
