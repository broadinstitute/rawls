...
trait ExpressionValidator {
  ...
  protected def validateInputExpr(allowRootEntity: Boolean, rootEntityTypeOption: Option[String] = None)(expression: String): Try[Unit]

  protected def validateOutputExpr(allowRootEntity: Boolean, rootEntityTypeOption: Option[String])(expression: String): Try[Unit]
}
