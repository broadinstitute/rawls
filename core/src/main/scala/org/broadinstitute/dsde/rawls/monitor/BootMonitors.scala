...
object BootMonitors extends LazyLogging {
  ...
  def bootMonitors(system: ActorSystem, conf: Config, slickDataSource: SlickDataSource, gcsDAO: GoogleServicesDAO,
                   samDAO: SamDAO, pubSubDAO: GooglePubSubDAO, methodRepoDAO: MethodRepoDAO, marthaDAO: MarthaDAO,
    ...
    startWorkflowSubmissionActors(system, conf, slickDataSource, gcsDAO, samDAO, methodRepoDAO, marthaDAO, shardedExecutionServiceCluster, maxActiveWorkflowsTotal, maxActiveWorkflowsPerUser, metricsPrefix)
