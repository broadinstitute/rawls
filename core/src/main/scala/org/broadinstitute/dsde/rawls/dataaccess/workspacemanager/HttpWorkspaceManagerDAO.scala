...
class HttpWorkspaceManagerDAO(apiClientProvider: WorkspaceManagerApiClientProvider)(implicit
  ...
  override def createWorkspaceWithSpendProfile(workspaceId: UUID,
    ...
    getWorkspaceApi(accessToken).createWorkspace(
  ...
  override def createAzureWorkspaceCloudContext(workspaceId: UUID,
    ...
    getWorkspaceApi(accessToken).createCloudContext(new CreateCloudContextRequest()
  ...
  override def updateDataRepoSnapshotReference(workspaceId: UUID,
    ...
    getReferencedGcpResourceApi(accessToken).updateDataRepoSnapshotReferenceResource(updateInfo,
                                                                                     workspaceId,
                                                                                     referenceId
    )

  override def deleteDataRepoSnapshotReference(workspaceId: UUID,
                                               referenceId: UUID,
                                               accessToken: OAuth2BearerToken
  ): Unit =
  ...
  override def enumerateDataRepoSnapshotReferences(workspaceId: UUID,
    ...
    getResourceApi(accessToken).enumerateResources(workspaceId,
                                                   offset,
                                                   limit,
