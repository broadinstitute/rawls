...
trait WorkspaceManagerDAO {
  ...
  /**
   * Create a GCP storage bucket in the workspace
   * @return
   * @param workspaceId UUID of the workspace
   * @param storageBucketName Name of the bucket
   * @param location GCP location for the bucket
   * @param ctx Rawls tracing context
   */
