  ...
  object entityQuery extends TableQuery(new EntityTable(_)) {
    ...
    private object EntityAndAttributesRawSqlQuery extends RawSqlQuery {
      ...
      def activeActionForPagination(workspaceContext: Workspace,
        ...
        for {
          unfilteredCount <- traceDBIOWithParent("findActiveEntityByType", parentSpan)(_ =>
    ...
    def checkAndCopyEntities(sourceWorkspaceContext: Workspace,
      ...
      traceDBIOWithParent("EntityComponent.checkAndCopyEntities", parentSpan) { s1 =>
        ...
        traceDBIOWithParent("getHardConflicts", s1)(s2 =>
