...
class UserInfoSpec extends AnyFlatSpec with Matchers {
  ...
  "UserInfo.isB2C" should "return false for Google users" in {
    ...
    val userInfo2 = UserInfo(RawlsUserEmail("fake@email.com"), OAuth2BearerToken("some-token"), 300, RawlsUserSubjectId("ABC81341723041"), None)
    userInfo2.isB2C shouldBe false
  }
