...
trait RawlsStatsDTestUtils extends StatsDTestUtils { this: Eventually with MockitoTestUtils =>
  ...
  protected def expectedWorkflowStatusGauge(workspaceName: WorkspaceName, submissionId: String, workflowStatus: WorkflowStatus, expectedRate: Int): (String, String) =
  ...
  protected def expectedSubmissionStatusGauge(workspaceName: WorkspaceName, submissionStatus: SubmissionStatus, expectedRate: Int): (String, String) =
  ...
  protected def expectedGlobalSubmissionStatusGauge(submissionStatus: SubmissionStatus, expectedRate: Int): (String, String) =
