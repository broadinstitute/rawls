...
abstract class MockGoogleStorageService[F[_]] extends GoogleStorageService[F] {
  override def listObjectsWithPrefix(bucketName: GcsBucketName,
                                     ...
                                     blobListOptions: List[Storage.BlobListOption]
  ): fs2.Stream[F, GcsObjectName] = ???
  ...
  override def getObjectMetadata(bucketName: GcsBucketName,
                                 ...
                                 retryConfig: RetryConfig,
                                 blobGetOptions: List[Storage.BlobGetOption]
  ): fs2.Stream[F, GetMetadataResponse] = ???
  ...
  override def removeObject(bucketName: GcsBucketName,
                            ...
                            traceId: Option[TraceId],
                            retryConfig: RetryConfig,
                            blobSourceOptions: List[Storage.BlobSourceOption]
  ): fs2.Stream[F, RemoveObjectResult] = ???
