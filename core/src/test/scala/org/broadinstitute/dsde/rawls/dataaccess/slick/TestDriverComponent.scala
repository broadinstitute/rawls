  ...
  class DefaultTestData() extends TestData {
    ...
    override def save() = {
      DBIO.seq(
        ...
        DBIO.from(samDataSaver.savePolicyGroups(testProject1Groups.values.flatten, SamResourceTypeNames.billingProject.value, billingProject.projectName.value)),
        rawlsBillingProjectQuery.create(testProject1),
        DBIO.from(samDataSaver.savePolicyGroups(testProject2Groups.values.flatten, SamResourceTypeNames.billingProject.value, billingProject.projectName.value)),
        rawlsBillingProjectQuery.create(testProject2),
        DBIO.from(samDataSaver.savePolicyGroups(testProject3Groups.values.flatten, SamResourceTypeNames.billingProject.value, billingProject.projectName.value)),
