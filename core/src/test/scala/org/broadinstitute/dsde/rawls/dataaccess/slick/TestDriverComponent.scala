...
trait TestDriverComponent extends DriverComponent with DataAccess with DefaultInstrumented {
  ...
  class DefaultTestData() extends TestData {
    ...
    val wsName2 = WorkspaceName("my-namespace", "myWorkspace2")
    val wsName3 = WorkspaceName("my-namespace", "myWSwithADsMethodConfigs")
    val wsName4 = WorkspaceName("my-namespace", "myWSwithADsMCSuccessfulSubmission")
    val wsName5 = WorkspaceName("my-namespace", "myWSwithADsMCFailedSubmission")
    val wsName6 = WorkspaceName("my-namespace", "myWSwithADsMCSubmittedSubmission")
    val wsName7 = WorkspaceName("my-namespace", "myWSwithADsMCAbortedSubmission")
    val wsName8 = WorkspaceName("my-namespace", "myWSwithADsMCAbortedSuccessfulSub")
    val wsName9 = WorkspaceName("my-namespace", "myWSToTestGrantPermissions")
    val wsName10 = WorkspaceName("my-namespace", "myMultiGroupADWorkspace")
    val wsNameConfigCopyDestination = WorkspaceName("my-namespace", "configCopyDestinationWS")
    val wsInterleaved = WorkspaceName("my-namespace", "myWSToTestInterleavedSubs")
    val wsWorkflowFailureMode = WorkspaceName("my-namespace", "myWSToTestWFFailureMode")
    val wsRegionalName = WorkspaceName("my-namespace", "myRegionalWorkspace")
    ...
    // Copy from "my-namespace/myWorkspace" to "my-namespace/configCopyDestinationWS"
  ...
  class MinimalTestData() extends TestData {
    val billingProject = RawlsBillingProject(RawlsBillingProjectName("my-namespace"), CreationStatuses.Ready, Option(RawlsBillingAccountName("billingAccounts/000000-111111-222222")), None)
