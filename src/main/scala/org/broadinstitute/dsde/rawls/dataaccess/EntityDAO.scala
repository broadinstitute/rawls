...
trait EntityDAO {
  ...
  def cloneAllEntities(entityDAO: EntityDAO, workspaceNamespace: String, newWorkspaceNamespace: String, workspaceName: String, newWorkspaceName: String, txn: RawlsTransaction): Unit
}
