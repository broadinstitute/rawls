...
trait MethodWiths {
  ...
  def withMethod[T](methodNamespace: String, methodName: String, methodVersion: Int, userInfo: UserInfo)(op: (AgoraEntity) => ReadWriteAction[T]): ReadWriteAction[T] = {
  ...
  def withMethodInputs[T](methodConfig: MethodConfiguration, userInfo: UserInfo)(op: (String, Seq[MethodInput]) => ReadWriteAction[T]): ReadWriteAction[T] = {
