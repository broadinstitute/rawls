...
class AttributeComponentSpec extends TestDriverComponentWithFlatSpecAndMatchers with AttributeComponent {
  ...
  "AttributeComponent" should "insert string attribute" in withEmptyTestDatabase {
    ...
    assertExpectedRecords(WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", Option("test"), None, None, None, None, None))
  }
  ...
  it should "insert number attribute" in withEmptyTestDatabase {
    ...
    assertExpectedRecords(WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, Option(3.14159), None, None, None, None))
  }
  ...
  it should "insert boolean attribute" in withEmptyTestDatabase {
    ...
    assertExpectedRecords(WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, None, Option(true), None, None, None))
  }
  ...
  it should "insert attribute value list" in withEmptyTestDatabase {
    ...
    assertExpectedRecords(
      WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, Option(9), None, None, Option(0), Option(4)),
      WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, Option(8), None, None, Option(1), Option(4)),
      WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, Option(7), None, None, Option(2), Option(4)),
      WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, Option(6), None, None, Option(3), Option(4)))
  }
  ...
  it should "insert empty list" in withEmptyTestDatabase {
    ...
    assertExpectedRecords(WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, None, None, None, Option(-1), Option(0)))
  }
  ...
  it should "insert null attribute" in withEmptyTestDatabase {
    ...
    assertExpectedRecords(WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, None, None, None, None, None))
  }
  ...
  it should "insert entity reference attribute" in withEmptyTestDatabase {
    ...
    assertExpectedRecords(WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, None, None, Option(entityId), None, None))
  }
  ...
  it should "insert entity reference attribute list" in withEmptyTestDatabase {
    ...
    assertExpectedRecords(
      WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, None, None, Option(entityId1), Option(0), Option(4)),
      WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, None, None, Option(entityId2), Option(1), Option(4)),
      WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, None, None, Option(entityId3), Option(2), Option(4)),
      WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test", None, None, None, Option(entityId4), Option(3), Option(4)))
  ...
  it should "delete attribute records" in withEmptyTestDatabase {
    runAndWait(workspaceQuery.save(workspace))
    val inserts = Seq(
      (workspaceAttributeQuery returning workspaceAttributeQuery.map(_.id)) += WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test1", None, Some(1), None, None, None, None),
      (workspaceAttributeQuery returning workspaceAttributeQuery.map(_.id)) += WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test2", None, Some(2), None, None, None, None),
      (workspaceAttributeQuery returning workspaceAttributeQuery.map(_.id)) += WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "test3", None, Some(3), None, None, None, None)) map { insert =>
  ...
  it should "unmarshall attribute records" in withEmptyTestDatabase {
    val attributeRecs = Seq(
      ((1, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "string", Some("value"), None, None, None, None, None)), None),
      ((1, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "num", None, Some(1), None, None, None, None)), None),
      ((1, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "bool", None, None, Some(true), None, None, None)), None),
      ((1, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "ref", None, None, None, Some(1), None, None)), Some(EntityRecord(0, "name", "type", workspaceId, 0, None))),
      ((1, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "null", None, None, None, None, None, None)), None),
      ((2, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "valList", None, Some(1), None, None, Some(2), Some(3))), None),
      ((2, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "valList", None, Some(2), None, None, Some(1), Some(3))), None),
      ((2, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "valList", None, Some(3), None, None, Some(0), Some(3))), None),
      ((1, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "refList", None, None, None, Some(1), Some(2), Some(3))), Some(EntityRecord(0, "name1", "type", workspaceId, 0, None))),
      ((1, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "refList", None, None, None, Some(2), Some(1), Some(3))), Some(EntityRecord(0, "name2", "type", workspaceId, 0, None))),
      ((1, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "refList", None, None, None, Some(3), Some(0), Some(3))), Some(EntityRecord(0, "name3", "type", workspaceId, 0, None))),
      ((1, WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "emptyList", None, Some(1), None, None, Some(-1), Some(0))), None)
    )
  ...
  it should "throw exception unmarshalling a list without listIndex set for all" in withEmptyTestDatabase {
    val attributeRecs = Seq(
      ((1 -> WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "valList", None, Some(1), None, None, Some(2), Some(3))), None),
      ((1 -> WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "valList", None, Some(2), None, None, None, Some(3))), None),
      ((1 -> WorkspaceAttributeRecord(dummyId2, workspaceId, 0, "valList", None, Some(3), None, None, Some(0), Some(3))), None)
    )
