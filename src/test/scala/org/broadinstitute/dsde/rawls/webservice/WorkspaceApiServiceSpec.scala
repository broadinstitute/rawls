...
class WorkspaceApiServiceSpec extends ApiServiceSpec {
  ...
  it should "*REENABLE WITH MYSQL UNIT TESTS* delete a workspace" in withTestDataApiServices { services =>
  ...
  it should "*REENABLE WITH MYSQL UNIT TESTS* delete workspace groups when deleting a workspace" in withTestDataApiServices { services =>
